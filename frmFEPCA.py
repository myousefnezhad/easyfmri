...
class frmFEPCA(Ui_frmFEPCA):
    ...
    def show(self):
        ...
        dialog.setWindowTitle("easy fMRI Principal Component Analysis (PCA) - V" + getVersion() + "B" + getBuild())
