...
class Ui_frmWholeBrainROI(object):
    def setupUi(self, frmWholeBrainROI):
        ...
        self.label_23.setGeometry(QtCore.QRect(20, 310, 541, 31))
        font = QtGui.QFont()
        ...
        frmWholeBrainROI.setTabOrder(self.txtSSTask, self.txtSSSubFrom)
        frmWholeBrainROI.setTabOrder(self.txtSSSubFrom, self.txtSSSubTo)
        frmWholeBrainROI.setTabOrder(self.txtSSSubTo, self.txtSSSubLen)
        frmWholeBrainROI.setTabOrder(self.txtSSSubLen, self.txtSSSubPer)
        frmWholeBrainROI.setTabOrder(self.txtSSSubPer, self.txtSSRunNum)
        frmWholeBrainROI.setTabOrder(self.txtSSRunNum, self.txtSSRunLen)
        frmWholeBrainROI.setTabOrder(self.txtSSRunLen, self.txtSSRunPer)
        frmWholeBrainROI.setTabOrder(self.txtSSRunPer, self.txtSSConFrom)
        frmWholeBrainROI.setTabOrder(self.txtSSConFrom, self.txtSSConTo)
        frmWholeBrainROI.setTabOrder(self.txtSSConTo, self.txtSSConLen)
    ...
    def retranslateUi(self, frmWholeBrainROI):
        ...
        self.label_13.setText(_translate("frmWholeBrainROI", "To:"))
        self.txtSSSubTo.setToolTip(_translate("frmWholeBrainROI", "<html><head/><body><p><span style=\" font-size:18pt; color:#0000ff;\">SubFrom: subject counter will be ended from this number</span></p><p><span style=\" font-size:18pt; color:#0000ff;\">SubTo &gt; 0 &amp;&amp; SubFrom &lt;= SubTo</span></p></body></html>"))
        self.label_10.setText(_translate("frmWholeBrainROI", "From:"))
        self.txtSSSubFrom.setToolTip(_translate("frmWholeBrainROI", "<html><head/><body><p><span style=\" font-size:18pt; color:#0000ff;\">SubFrom: subject counter will be started from this number</span></p><p><span style=\" font-size:18pt; color:#0000ff;\">SubForm &gt; 0 &amp;&amp; SubFrom &lt;= SubTo</span></p></body></html>"))
        ...
        self.label_16.setText(_translate("frmWholeBrainROI", "Number:"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_10), _translate("frmWholeBrainROI", "Run"))
        self.label_17.setText(_translate("frmWholeBrainROI", "From:"))
        self.label_43.setText(_translate("frmWholeBrainROI", "Length:"))
        self.label_44.setText(_translate("frmWholeBrainROI", "To:"))
