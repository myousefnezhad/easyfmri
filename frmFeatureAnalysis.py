...
from utility import fixstr, setParameters2, getDirSpaceINI, getDirSpace, setParameters3, convertDesignMatrix, fitLine
...
class frmFeatureAnalysis(Ui_frmFeatureAnalysis):
    ...
    def show(self, parentin=None):
        ...
        # Just for build 1000
        ui.btnFEPCA.setEnabled(False)
        ui.btnFEICA.setEnabled(False)
        ui.btnFEMRPA.setEnabled(False)
        ui.btnFAHA.setEnabled(False)
        ui.btnFAGPUHA.setEnabled(False)
        ...
        for si, s in enumerate(range(SubFrom, SubTo + 1)):
            for cnt in range(ConFrom, ConTo + 1):
                ...
                for r in range(1, Run[si] + 1):
                    MatFile = setParameters2(Mat, mainDIR, fixstr(s, SubLen, ui.txtSSSubPer.text()), \
                    ...
                    SpaceFile = setParameters2(Space, mainDIR, fixstr(s, SubLen, ui.txtSSSubPer.text()), \
                                               fixstr(r, RunLen, ui.txtSSRunPer.text()), ui.txtSSTask.text(), \
                                               fixstr(cnt, ConLen, ui.txtSSConPer.text()))
        ...
        for si, s in enumerate(range(SubFrom, SubTo + 1)):
            for cnt in range(ConFrom, ConTo + 1):
                ...
                for r in range(1, Run[si] + 1):
                    ...
                    OutFile = setParameters2(Out, mainDIR, fixstr(s, SubLen, ui.txtSSSubPer.text()), \
                                             fixstr(r, RunLen, ui.txtSSRunPer.text()), ui.txtSSTask.text(), \
                                             fixstr(cnt, ConLen, ui.txtSSConPer.text()))
    ...
    def btnDIRUN_click(self):
        ...
        for si, s in enumerate(range(SubFrom, SubTo + 1)):
            for cnt in range(ConFrom, ConTo + 1):
                ...
                # SubDIR = setting.mainDIR + "/" + "sub-" + fixstr(s, SubLen, setting.SubPer)
                for r in range(1, Run[si] + 1):
                    InFile = setParameters2(In, mainDIR, fixstr(s, SubLen, ui.txtDISubPer.text()), \
                    ...
                    if ui.rbDIDynamic.isChecked() or ui.cbDIDM.isChecked():
                        ...
                        DMFile = setParameters2(DM, mainDIR, fixstr(s, SubLen, ui.txtDISubPer.text()), \
                                            fixstr(r, RunLen, ui.txtDIRunPer.text()), ui.txtDITask.text(), \
                                            fixstr(cnt, ConLen, ui.txtDIConPer.text()))
                        ...
                        LBFile = setParameters2(LB, mainDIR, fixstr(s, SubLen, ui.txtDISubPer.text()), \
                                            fixstr(r, RunLen, ui.txtDIRunPer.text()), ui.txtDITask.text(), \
                                            fixstr(cnt, ConLen, ui.txtDIConPer.text()))
