...
from GUI.frmFAARHAGUI import *
from Hyperalignment.ARHA import ARHA
from IO.mainIO import mainIO_load, mainIO_save, reshape_1Dvector


class frmFAARHA(Ui_frmFAARHA):
    ui = Ui_frmFAARHA()
    dialog = None
    ...
    def show(self):
        ...
        dialog.setWindowTitle("easy fMRI Autoregressive Hyperalignment (ARHA) - V" + getVersion() + "B" + getBuild())
    ...
    def btnConvert_click(self):
        ...
        for fold_all in range(FoldFrom, FoldTo+1):
            ...
            model = ARHA(Dim=NumFea, regularization=Regularization, rho=Rho, rank=Rank)
        ...
        print("Autoregressive Hyperalignment is done.")
        msgBox.setText("Autoregressive Hyperalignment is done.")
