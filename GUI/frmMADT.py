...
class frmMADT(Ui_frmMADT):
    ...
    def show(self):
        ...
        # Splitter
        ui.cbSplitter.addItem("best")
        ui.cbSplitter.addItem("random")
        ...
        dialog.setWindowTitle("easy fMRI Decision Tree Classifier - V" + getVersion() + "B" + getBuild())
    ...
    def btnConvert_click(self):
        ...
        # Splitter
        Splitter = ui.cbSplitter.currentText()

        # Presort
        Presort = ui.cbPresort.isChecked()
        ...
        OutData = dict()
        OutData["ModelAnalysis"] = "Decision Tree Classifier"
        ...
        for fold in range(FoldFrom, FoldTo + 1):
            ...
            try:
                clf = DecisionTreeClassifier(criterion=Criterion,splitter=Splitter,max_depth=MaxDepth,\
                                             ...
                                             min_impurity_split=MinImpuritySplit,presort=Presort)
