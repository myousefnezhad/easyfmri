...
class Ui_frmMAGMDeepRSA(object):
    def setupUi(self, frmMAGMDeepRSA):
        ...
        self.btnConvert.setGeometry(QtCore.QRect(690, 660, 141, 32))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(30, 140, 801, 501))
        ...
        self.label_26.setGeometry(QtCore.QRect(20, 410, 131, 16))
        ...
        self.label_27.setGeometry(QtCore.QRect(20, 26, 71, 16))
        self.label_27.setObjectName("label_27")
        self.txtFontSize = QtWidgets.QSpinBox(self.tab_6)
        self.txtFontSize.setGeometry(QtCore.QRect(220, 20, 171, 35))
        ...
        self.cbBeta.setGeometry(QtCore.QRect(180, 90, 111, 22))
        self.cbBeta.setChecked(True)
        self.cbBeta.setObjectName("cbBeta")
        self.btnRedraw = QtWidgets.QPushButton(frmMAGMDeepRSA)
        self.btnRedraw.setGeometry(QtCore.QRect(530, 660, 141, 32))
        self.btnRedraw.setObjectName("btnRedraw")
        self.label_22 = QtWidgets.QLabel(frmMAGMDeepRSA)
        self.label_22.setGeometry(QtCore.QRect(530, 90, 71, 16))
        self.label_22.setObjectName("label_22")
        self.cbDevice = QtWidgets.QComboBox(frmMAGMDeepRSA)
        self.cbDevice.setGeometry(QtCore.QRect(600, 90, 181, 26))
        self.cbDevice.setObjectName("cbDevice")
        self.cbNetwork = QtWidgets.QCheckBox(frmMAGMDeepRSA)
        self.cbNetwork.setGeometry(QtCore.QRect(300, 90, 221, 22))
    ...
    def retranslateUi(self, frmMAGMDeepRSA):
        ...
        self.label_24.setText(_translate("frmMAGMDeepRSA", "imgShape"))
        self.label_25.setText(_translate("frmMAGMDeepRSA", "Coordinate"))
        self.label_26.setText(_translate("frmMAGMDeepRSA", "Condition"))
        ...
        self.label_27.setText(_translate("frmMAGMDeepRSA", "Font Size"))
        self.label_28.setText(_translate("frmMAGMDeepRSA", "Figure Title: Cov (Null = Auto)"))
        self.label_29.setText(_translate("frmMAGMDeepRSA", "Figure Title: Corr (Null = Auto)"))
        self.label_30.setText(_translate("frmMAGMDeepRSA", "Figure Title: Den (Null = Auto)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("frmMAGMDeepRSA", "Options"))
        ...
        self.cbBeta.setText(_translate("frmMAGMDeepRSA", "Save Beta"))
        self.btnRedraw.setText(_translate("frmMAGMDeepRSA", "Redraw"))
        self.label_22.setText(_translate("frmMAGMDeepRSA", "Device"))
        self.cbNetwork.setText(_translate("frmMAGMDeepRSA", "Save Network Parameters"))
