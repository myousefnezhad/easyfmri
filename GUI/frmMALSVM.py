...
class frmMALSVM(Ui_frmMALSVM):
    ...
    def show(self):
        ...
        ui.cbMode.addItem("Crammer Singer","crammer_singer")
        ...
        dialog.setWindowTitle("easy fMRI Linear Support Vector Classification - V" + getVersion() + "B" + getBuild())
    ...
    def btnConvert_click(self):
        ...
        # Dual
        Dual = ui.cbDual.isChecked()
        # Dual
        Intercept = ui.cbIntercept.isChecked()
        ...
        OutData = dict()
        OutData["ModelAnalysis"] = "Linear Support Vector Classification"
        ...
        for fold in range(FoldFrom, FoldTo + 1):
            ...
            try:
                ...
                return
            try:
                clf = LinearSVC(C=C,penalty=Penalty,loss=Loss,dual=Dual,tol=Tol,multi_class=Model,\
                                fit_intercept=Intercept,max_iter=MaxIter)
        ...
        print("DONE.")
        msgBox.setText("Linear Support Vector Classification is done.")
