...
class Ui_frmMARFC(object):
    def setupUi(self, frmMARFC):
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(60, 220, 701, 201))
        ...
        self.label_27.setGeometry(QtCore.QRect(570, 160, 111, 16))
        ...
        self.label_28.setGeometry(QtCore.QRect(20, 160, 201, 16))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(60, 10, 701, 201))
    ...
    def retranslateUi(self, frmMARFC):
        ...
        self.groupBox_3.setTitle(_translate("frmMARFC", "<Based on a reference>"))
        self.cbFilterTrID.setText(_translate("frmMARFC", "Filter training based on"))
        self.label_6.setText(_translate("frmMARFC", "Remove training contents"))
        self.label_13.setText(_translate("frmMARFC", "e.g. 0 or [1,2]"))
        self.label_27.setText(_translate("frmMARFC", "e.g. 0 or [1,2]"))
        self.cbFilterTeID.setText(_translate("frmMARFC", "Filter testing based on"))
        self.label_28.setText(_translate("frmMARFC", "Remove testing contents"))
        self.btnShowFilterContent.setText(_translate("frmMARFC", "Show Content"))
        self.groupBox_2.setTitle(_translate("frmMARFC", "<Filter based on Class ID>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("frmMARFC", "Filter"))
