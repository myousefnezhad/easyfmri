...
class Ui_frmRenameFile(object):
    ...
    def retranslateUi(self, frmRenameFile):
        ...
        self.label_5.setText(_translate("frmRenameFile", "Task Name(s):"))
        self.txtTask.setToolTip(_translate("frmRenameFile", "<html><head/><body><p><span style=\" font-size:18pt; color:#0000ff;\">Task Names: a unique array of integers, i.e., [task1, task2, ...]</span></p><p><span style=\" font-size:18pt; color:#0000ff;\">, is the separator</span></p></body></html>"))
