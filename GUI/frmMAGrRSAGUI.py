...
class Ui_frmMAGrRSA(object):
    ...
    def retranslateUi(self, frmMAGrRSA):
        ...
        self.label_31.setText(_translate("frmMAGrRSA", "Condition"))
        ...
        self.label_16.setText(_translate("frmMAGrRSA", "Epoch"))
        self.txtIter.setText(_translate("frmMAGrRSA", "10"))
        self.label_17.setText(_translate("frmMAGrRSA", "Batch Size"))
        self.txtBatch.setText(_translate("frmMAGrRSA", "10"))
        self.label_18.setText(_translate("frmMAGrRSA", "Report Step every"))
        self.txtReportStep.setText(_translate("frmMAGrRSA", "2"))
        self.txtRate.setText(_translate("frmMAGrRSA", "0.1"))
        self.label_19.setText(_translate("frmMAGrRSA", "Learning Rate"))
        self.txtLParam.setText(_translate("frmMAGrRSA", "1"))
        self.label_20.setText(_translate("frmMAGrRSA", "LASSO Alpha"))
        self.label_22.setText(_translate("frmMAGrRSA", "Elastic L1 ratio"))
        self.txtEL1.setText(_translate("frmMAGrRSA", "0.5"))
        self.label_23.setText(_translate("frmMAGrRSA", "Elastic Alpha"))
        self.txtEL2.setText(_translate("frmMAGrRSA", "1"))
        self.label_24.setText(_translate("frmMAGrRSA", "Ridge Regression Param"))
        self.txtRRP.setText(_translate("frmMAGrRSA", "1"))
        self.cbVerbose.setText(_translate("frmMAGrRSA", "Verbose"))
        self.label_13.setText(_translate("frmMAGrRSA", "Method"))
        self.label_14.setText(_translate("frmMAGrRSA", "Loss Type"))
        self.label_15.setText(_translate("frmMAGrRSA", "Optimization"))
        ...
        self.label_27.setText(_translate("frmMAGrRSA", "Font Size"))
        self.label_29.setText(_translate("frmMAGrRSA", "Figure Title: Corr (Null = Auto)"))
        self.label_30.setText(_translate("frmMAGrRSA", "Figure Title: Den (Null = Auto)"))
        self.label_28.setText(_translate("frmMAGrRSA", "Figure Title: Cov (Null = Auto)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmMAGrRSA", "Options"))
