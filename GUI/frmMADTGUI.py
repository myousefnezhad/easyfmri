...
class Ui_frmMADT(object):
    def setupUi(self, frmMADT):
        ...
        self.btnClose.setGeometry(QtCore.QRect(20, 715, 141, 32))
        self.btnClose.setObjectName("btnClose")
        self.tabWidget = QtWidgets.QTabWidget(frmMADT)
        self.tabWidget.setGeometry(QtCore.QRect(20, 150, 741, 551))
        ...
        self.label_24.setGeometry(QtCore.QRect(590, 80, 111, 16))
        self.label_24.setObjectName("label_24")
        self.txtFilterTrContent = QtWidgets.QLineEdit(self.groupBox_3)
        self.txtFilterTrContent.setGeometry(QtCore.QRect(190, 80, 391, 21))
        ...
        self.label_25.setGeometry(QtCore.QRect(590, 160, 111, 16))
        ...
        self.txtFilterTeContent.setGeometry(QtCore.QRect(190, 160, 391, 21))
        ...
        self.label_26.setGeometry(QtCore.QRect(20, 160, 201, 16))
        ...
        self.txtFilter.setGeometry(QtCore.QRect(190, 40, 411, 21))
        self.txtFilter.setObjectName("txtFilter")
        self.label_5 = QtWidgets.QLabel(self.groupBox_2)
        self.label_5.setGeometry(QtCore.QRect(610, 40, 111, 16))
    ...
    def retranslateUi(self, frmMADT):
        ...
        self.groupBox_3.setTitle(_translate("frmMADT", "<Based on a reference>"))
        self.cbFilterTrID.setText(_translate("frmMADT", "Filter training based on"))
        self.label_6.setText(_translate("frmMADT", "Remove training contents"))
        self.label_24.setText(_translate("frmMADT", "e.g. 0 or [1,2]"))
        self.label_25.setText(_translate("frmMADT", "e.g. 0 or [1,2]"))
        self.cbFilterTeID.setText(_translate("frmMADT", "Filter testing based on"))
        self.label_26.setText(_translate("frmMADT", "Remove testing contents"))
        self.btnShowFilterContent.setText(_translate("frmMADT", "Show Content"))
        self.groupBox_2.setTitle(_translate("frmMADT", "<Filter based on Class ID>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("frmMADT", "Filter"))
