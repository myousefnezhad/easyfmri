...
class Ui_frmMAGNB(object):
    def setupUi(self, frmMAGNB):
        ...
        self.btnConvert.setGeometry(QtCore.QRect(620, 630, 141, 32))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(30, 150, 731, 461))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 220, 701, 201))
        ...
        self.label_11.setGeometry(QtCore.QRect(570, 80, 111, 16))
        ...
        self.label_14.setGeometry(QtCore.QRect(570, 160, 111, 16))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 10, 701, 201))
        ...
        self.label_12.setGeometry(QtCore.QRect(185, 635, 421, 20))
    ...
    def retranslateUi(self, frmMAGNB):
        ...
        self.groupBox_3.setTitle(_translate("frmMAGNB", "<Based on a reference>"))
        self.cbFilterTrID.setText(_translate("frmMAGNB", "Filter training based on"))
        self.label_6.setText(_translate("frmMAGNB", "Remove training contents"))
        self.label_11.setText(_translate("frmMAGNB", "e.g. 0 or [1,2]"))
        self.label_14.setText(_translate("frmMAGNB", "e.g. 0 or [1,2]"))
        self.cbFilterTeID.setText(_translate("frmMAGNB", "Filter testing based on"))
        self.label_16.setText(_translate("frmMAGNB", "Remove testing contents"))
        self.btnShowFilterContent.setText(_translate("frmMAGNB", "Show Content"))
        self.groupBox_2.setTitle(_translate("frmMAGNB", "<Filter based on Class ID>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("frmMAGNB", "Filter"))
