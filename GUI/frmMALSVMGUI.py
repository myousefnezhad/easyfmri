...
class Ui_frmMALSVM(object):
    def setupUi(self, frmMALSVM):
        ...
        self.label_15.setGeometry(QtCore.QRect(570, 160, 111, 16))
    ...
    def retranslateUi(self, frmMALSVM):
        ...
        self.groupBox_3.setTitle(_translate("frmMALSVM", "<Based on a reference>"))
        self.cbFilterTrID.setText(_translate("frmMALSVM", "Filter training based on"))
        self.label_6.setText(_translate("frmMALSVM", "Remove training contents"))
        self.label_11.setText(_translate("frmMALSVM", "e.g. 0 or [1,2]"))
        self.label_15.setText(_translate("frmMALSVM", "e.g. 0 or [1,2]"))
        self.cbFilterTeID.setText(_translate("frmMALSVM", "Filter testing based on"))
        self.label_18.setText(_translate("frmMALSVM", "Remove testing contents"))
        self.btnShowFilterContent.setText(_translate("frmMALSVM", "Show Content"))
        self.groupBox_2.setTitle(_translate("frmMALSVM", "<Filter based on Class ID>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("frmMALSVM", "Filter"))
