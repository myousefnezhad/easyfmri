# Form implementation generated from reading ui file 'frmFAARSRMGUI.ui'
#
...
class Ui_frmFAARSRM(object):
    def setupUi(self, frmFAARSRM):
        ...
        self.cbSaveShare.setGeometry(QtCore.QRect(30, 540, 181, 21))
        self.cbSaveShare.setObjectName("cbSaveShare")
        self.cbSaveMap = QtWidgets.QCheckBox(self.tab_2)
        self.cbSaveMap.setGeometry(QtCore.QRect(230, 540, 211, 21))
        self.cbSaveMap.setObjectName("cbSaveMap")
        self.txtRho = QtWidgets.QLineEdit(self.tab_2)
        self.txtRho.setGeometry(QtCore.QRect(260, 490, 160, 21))
        self.txtRho.setObjectName("txtRho")
        self.label_13 = QtWidgets.QLabel(self.tab_2)
        self.label_13.setGeometry(QtCore.QRect(30, 450, 221, 16))
        self.label_13.setObjectName("label_13")
        self.label_15 = QtWidgets.QLabel(self.tab_2)
        self.label_15.setGeometry(QtCore.QRect(30, 490, 221, 16))
        self.label_15.setObjectName("label_15")
        self.txtRank = QtWidgets.QLineEdit(self.tab_2)
        self.txtRank.setGeometry(QtCore.QRect(260, 450, 160, 21))
        ...
        self.label_12 = QtWidgets.QLabel(frmFAARSRM)
        self.label_12.setGeometry(QtCore.QRect(185, 735, 421, 20))
        self.label_12.setObjectName("label_12")

        self.retranslateUi(frmFAARSRM)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(frmFAARSRM)
        frmFAARSRM.setTabOrder(self.txtInFile, self.btnInFile)
        frmFAARSRM.setTabOrder(self.btnInFile, self.txtOutFile)
        frmFAARSRM.setTabOrder(self.txtOutFile, self.btnOutFile)
        frmFAARSRM.setTabOrder(self.btnOutFile, self.tabWidget)
        frmFAARSRM.setTabOrder(self.tabWidget, self.cbmLabel)
        frmFAARSRM.setTabOrder(self.cbmLabel, self.cbCol)
        frmFAARSRM.setTabOrder(self.cbCol, self.cbDM)
        frmFAARSRM.setTabOrder(self.cbDM, self.cbTask)
        frmFAARSRM.setTabOrder(self.cbTask, self.cbRun)
        frmFAARSRM.setTabOrder(self.cbRun, self.cbCounter)
        frmFAARSRM.setTabOrder(self.cbCounter, self.cbCond)
        frmFAARSRM.setTabOrder(self.cbCond, self.cbNScan)
        frmFAARSRM.setTabOrder(self.cbNScan, self.txtITrData)
        frmFAARSRM.setTabOrder(self.txtITrData, self.txtITrLabel)
        frmFAARSRM.setTabOrder(self.txtITrLabel, self.txtITrSubject)
        frmFAARSRM.setTabOrder(self.txtITrSubject, self.txtITrmLabel)
        frmFAARSRM.setTabOrder(self.txtITrmLabel, self.txtCol)
        frmFAARSRM.setTabOrder(self.txtCol, self.txtITrDM)
        frmFAARSRM.setTabOrder(self.txtITrDM, self.txtITrTask)
        frmFAARSRM.setTabOrder(self.txtITrTask, self.txtITrRun)
        frmFAARSRM.setTabOrder(self.txtITrRun, self.txtITrCounter)
        frmFAARSRM.setTabOrder(self.txtITrCounter, self.txtITrScan)
        frmFAARSRM.setTabOrder(self.txtITrScan, self.txtOTrData)
        frmFAARSRM.setTabOrder(self.txtOTrData, self.txtOTrLabel)
        frmFAARSRM.setTabOrder(self.txtOTrLabel, self.txtOTrSubject)
        frmFAARSRM.setTabOrder(self.txtOTrSubject, self.txtOTrmLabel)
        frmFAARSRM.setTabOrder(self.txtOTrmLabel, self.txtOCol)
        frmFAARSRM.setTabOrder(self.txtOCol, self.txtOTrDM)
        frmFAARSRM.setTabOrder(self.txtOTrDM, self.txtOTrTask)
        frmFAARSRM.setTabOrder(self.txtOTrTask, self.txtOTrRun)
        frmFAARSRM.setTabOrder(self.txtOTrRun, self.txtOTrCounter)
        frmFAARSRM.setTabOrder(self.txtOTrCounter, self.txtOCond)
        frmFAARSRM.setTabOrder(self.txtOCond, self.txtOTrScan)
        frmFAARSRM.setTabOrder(self.txtOTrScan, self.txtCond)
        frmFAARSRM.setTabOrder(self.txtCond, self.btnConvert)
        frmFAARSRM.setTabOrder(self.btnConvert, self.btnClose)

    def retranslateUi(self, frmFAARSRM):
        _translate = QtCore.QCoreApplication.translate
        frmFAARSRM.setWindowTitle(_translate("frmFAARSRM", "Shared Response Model (SRM)"))
        self.btnInFile.setText(_translate("frmFAARSRM", "..."))
        self.label_33.setText(_translate("frmFAARSRM", "Input Data"))
        self.btnOutFile.setText(_translate("frmFAARSRM", "..."))
        self.btnConvert.setText(_translate("frmFAARSRM", "Alignment"))
        self.label_35.setText(_translate("frmFAARSRM", "Output Data"))
        self.btnClose.setText(_translate("frmFAARSRM", "Close"))
        self.txtOTrTask.setText(_translate("frmFAARSRM", "train_task"))
        self.cbmLabel.setText(_translate("frmFAARSRM", "Label (matrix)"))
        self.txtOTrmLabel.setText(_translate("frmFAARSRM", "train_mlabel"))
        self.label_2.setText(_translate("frmFAARSRM", "Data"))
        self.txtOTrDM.setText(_translate("frmFAARSRM", "train_design"))
        self.cbTask.setText(_translate("frmFAARSRM", "Task"))
        self.label_3.setText(_translate("frmFAARSRM", "Label"))
        self.cbNScan.setText(_translate("frmFAARSRM", "NScan"))
        self.cbCond.setText(_translate("frmFAARSRM", "Condition"))
        self.cbDM.setText(_translate("frmFAARSRM", "Design Matrix"))
        self.cbCol.setText(_translate("frmFAARSRM", "Coordinate"))
        self.txtOCond.setText(_translate("frmFAARSRM", "condition"))
        self.label.setText(_translate("frmFAARSRM", "Input"))
        self.txtOTrLabel.setText(_translate("frmFAARSRM", "train_label"))
        self.txtOTrScan.setText(_translate("frmFAARSRM", "train_nscan"))
        self.cbCounter.setText(_translate("frmFAARSRM", "Counter"))
        self.txtOCol.setText(_translate("frmFAARSRM", "coordinate"))
        self.label_5.setText(_translate("frmFAARSRM", "Output"))
        self.txtOTrCounter.setText(_translate("frmFAARSRM", "train_counter"))
        self.txtOTrSubject.setText(_translate("frmFAARSRM", "train_subject"))
        self.cbRun.setText(_translate("frmFAARSRM", "Run"))
        self.txtOTrData.setText(_translate("frmFAARSRM", "train_data"))
        self.txtOTrRun.setText(_translate("frmFAARSRM", "train_run"))
        self.txtOTeLabel.setText(_translate("frmFAARSRM", "test_label"))
        self.txtOTeRun.setText(_translate("frmFAARSRM", "test_run"))
        self.txtOTemLabel.setText(_translate("frmFAARSRM", "test_mlabel"))
        self.txtOTeDM.setText(_translate("frmFAARSRM", "test_design"))
        self.txtOTeData.setText(_translate("frmFAARSRM", "test_data"))
        self.txtOTeCounter.setText(_translate("frmFAARSRM", "test_counter"))
        self.txtOTeSubject.setText(_translate("frmFAARSRM", "test_subject"))
        self.txtOTeTask.setText(_translate("frmFAARSRM", "test_task"))
        self.txtOTeScan.setText(_translate("frmFAARSRM", "test_nscan"))
        self.label_7.setText(_translate("frmFAARSRM", "Train"))
        self.label_8.setText(_translate("frmFAARSRM", "Test"))
        self.label_9.setText(_translate("frmFAARSRM", "Train"))
        self.label_10.setText(_translate("frmFAARSRM", "Test"))
        self.cbFoldID.setText(_translate("frmFAARSRM", "FoldID"))
        self.txtOFoldID.setText(_translate("frmFAARSRM", "FoldID"))
        self.cbFoldInfo.setText(_translate("frmFAARSRM", "FoldInfo"))
        self.txtOFoldInfo.setText(_translate("frmFAARSRM", "FoldInfo"))
        self.lbFoldID.setText(_translate("frmFAARSRM", "ID=None"))
        self.label_6.setText(_translate("frmFAARSRM", "Subject"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("frmFAARSRM", "Data"))
        self.groupBox.setTitle(_translate("frmFAARSRM", "<Input Data Normalization>"))
        self.cbScale.setText(_translate("frmFAARSRM", "Scale Data X~N(0,1)"))
        self.rbScale.setText(_translate("frmFAARSRM", "Subject Level"))
        self.radioButton.setText(_translate("frmFAARSRM", "Whole Data"))
        self.groupBox_2.setTitle(_translate("frmFAARSRM", "<Alignment Level>"))
        self.cbFTask.setText(_translate("frmFAARSRM", "Task"))
        self.cbFCounter.setText(_translate("frmFAARSRM", "Counter"))
        self.groupBox_3.setTitle(_translate("frmFAARSRM", "<Subject Level>"))
        self.cbFSubject.setText(_translate("frmFAARSRM", "Subject"))
        self.radioButton_2.setText(_translate("frmFAARSRM", "Without Run"))
        self.rbFRun.setText(_translate("frmFAARSRM", "With Run"))
        self.label_11.setText(_translate("frmFAARSRM", "Number of iterations"))
        self.txtIter.setText(_translate("frmFAARSRM", "10"))
        self.lblFeaNum.setText(_translate("frmFAARSRM", "No Data"))
        self.label_4.setText(_translate("frmFAARSRM", "Number of features"))
        self.lblFeaNum_3.setText(_translate("frmFAARSRM", "Just for Robust SRM"))
        self.label_14.setText(_translate("frmFAARSRM", "Gamma "))
        self.label_21.setText(_translate("frmFAARSRM", "Method"))
        self.txtGamma.setText(_translate("frmFAARSRM", "1.0"))
        self.cbSaveShare.setText(_translate("frmFAARSRM", "Save shared space"))
        self.cbSaveMap.setText(_translate("frmFAARSRM", "Save mapping matrices"))
        self.txtRho.setText(_translate("frmFAARSRM", "0.5"))
        self.label_13.setText(_translate("frmFAARSRM", "Autoregressive rank"))
        self.label_15.setText(_translate("frmFAARSRM", "Autoregressive rho"))
        self.txtRank.setText(_translate("frmFAARSRM", "1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("frmFAARSRM", "Parameters"))
        self.label_17.setText(_translate("frmFAARSRM", "From:"))
        self.label_44.setText(_translate("frmFAARSRM", "To:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmFAARSRM", "Fold"))
        self.label_12.setText(_translate("frmFAARSRM", "$FOLD$ will be replaced by fold number."))
