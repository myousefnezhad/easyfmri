...
class Ui_frmMASKRSA(object):
    ...
    def retranslateUi(self, frmMASKRSA):
        ...
        self.label_31.setText(_translate("frmMASKRSA", "Condition"))
        ...
        self.label_28.setText(_translate("frmMASKRSA", "Figure Title: Cov (Null = Auto)"))
        self.label_30.setText(_translate("frmMASKRSA", "Figure Title: Den (Null = Auto)"))
        self.label_29.setText(_translate("frmMASKRSA", "Figure Title: Corr (Null = Auto)"))
        self.label_27.setText(_translate("frmMASKRSA", "Font Size"))
        self.label_32.setText(_translate("frmMASKRSA", "X Rotation"))
        self.label_34.setText(_translate("frmMASKRSA", "Y Rotation"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmMASKRSA", "Options"))
