...
# Form implementation generated from reading ui file 'frmFAKRHAGUI.ui'
#
...
class Ui_frmFAKHA(object):
    def setupUi(self, frmFAKHA):
        ...
        self.txtIter.setGeometry(QtCore.QRect(650, 500, 160, 21))
        self.txtIter.setObjectName("txtIter")
        self.label_24 = QtWidgets.QLabel(self.tab_2)
        self.label_24.setGeometry(QtCore.QRect(420, 500, 231, 16))
    ...
    def retranslateUi(self, frmFAKHA):
        ...
        self.label_11.setText(_translate("frmFAKHA", "HA Regularization"))
        self.txtRegularization.setText(_translate("frmFAKHA", "0.4"))
        ...
        self.label_16.setText(_translate("frmFAKHA", "Kernel Alpha"))
        self.txtTole.setText(_translate("frmFAKHA", "0"))
        self.txtMaxIter.setText(_translate("frmFAKHA", "0"))
        self.label_22.setText(_translate("frmFAKHA", "Kernel Iterations (None=0)"))
        ...
        self.txtIter.setText(_translate("frmFAKHA", "5"))
        self.label_24.setText(_translate("frmFAKHA", "HA Iterations"))
