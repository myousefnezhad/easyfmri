...
# Form implementation generated from reading ui file 'frmMASVMGUI.ui'
#
...
class Ui_frmMASVM(object):
    def setupUi(self, frmMASVM):
        ...
        self.txtC.setGeometry(QtCore.QRect(260, 200, 160, 21))
        ...
        self.retranslateUi(frmMASVM)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(frmMASVM)
        frmMASVM.setTabOrder(self.txtInFile, self.btnInFile)
        frmMASVM.setTabOrder(self.btnInFile, self.txtOutFile)
        frmMASVM.setTabOrder(self.txtOutFile, self.btnOutFile)
        frmMASVM.setTabOrder(self.btnOutFile, self.tabWidget)
        frmMASVM.setTabOrder(self.tabWidget, self.txtITrData)
        frmMASVM.setTabOrder(self.txtITrData, self.txtITrLabel)
        frmMASVM.setTabOrder(self.txtITrLabel, self.btnConvert)
        frmMASVM.setTabOrder(self.btnConvert, self.btnClose)

    def retranslateUi(self, frmMASVM):
        _translate = QtCore.QCoreApplication.translate
        frmMASVM.setWindowTitle(_translate("frmMASVM", "C Support Vector Classification"))
        self.btnInFile.setText(_translate("frmMASVM", "..."))
        self.label_33.setText(_translate("frmMASVM", "Input Data (per fold)"))
        self.btnOutFile.setText(_translate("frmMASVM", "..."))
        self.btnConvert.setText(_translate("frmMASVM", "Analyze"))
        self.label_35.setText(_translate("frmMASVM", "Analysis Results"))
        self.btnClose.setText(_translate("frmMASVM", "Close"))
        self.label_2.setText(_translate("frmMASVM", "Data"))
        self.label_3.setText(_translate("frmMASVM", "Label"))
        self.label.setText(_translate("frmMASVM", "Input"))
        self.label_7.setText(_translate("frmMASVM", "Train"))
        self.label_8.setText(_translate("frmMASVM", "Test"))
        self.label_9.setText(_translate("frmMASVM", "FoldID"))
        self.lbFoldID.setText(_translate("frmMASVM", "ID=None"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("frmMASVM", "Data"))
        self.groupBox.setTitle(_translate("frmMASVM", "<Input Data Normalization>"))
        self.cbScale.setText(_translate("frmMASVM", "Scale Data Train~N(0,1) and Test~N(0,1)"))
        self.txtGamma.setText(_translate("frmMASVM", "0"))
        self.txtMaxIter.setText(_translate("frmMASVM", "-1"))
        self.txtTole.setText(_translate("frmMASVM", "0.001"))
        self.lblFeaNum_3.setText(_translate("frmMASVM", "Coefficient for rbf, poly and sigmoid."))
        self.label_14.setText(_translate("frmMASVM", "Tolerance"))
        self.lblFeaNum_4.setText(_translate("frmMASVM", "Term in poly and sigmoid kernels. "))
        self.label_18.setText(_translate("frmMASVM", "Coef0"))
        self.label_11.setText(_translate("frmMASVM", "Gamma (Auto=0)"))
        self.label_15.setText(_translate("frmMASVM", "Degree"))
        self.label_13.setText(_translate("frmMASVM", "Kernel"))
        self.txtCoef0.setText(_translate("frmMASVM", "0"))
        self.label_16.setText(_translate("frmMASVM", "Maximum Iterations (No Limit=-1)"))
        self.lblFeaNum_5.setText(_translate("frmMASVM", "Tolerance for stopping criterion"))
        self.lblFeaNum_2.setText(_translate("frmMASVM", "Degree for poly kernels."))
        self.txtDegree.setText(_translate("frmMASVM", "3"))
        self.label_19.setText(_translate("frmMASVM", "Mode"))
        self.label_20.setText(_translate("frmMASVM", "C"))
        self.txtC.setText(_translate("frmMASVM", "1"))
        self.cbProbablity.setText(_translate("frmMASVM", "Enable probability estimates"))
        self.cbShrink.setText(_translate("frmMASVM", "Use shrinking heuristic"))
        self.lblFeaNum_6.setText(_translate("frmMASVM", "Penalty parameter "))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("frmMASVM", "Parameters"))
        self.label_17.setText(_translate("frmMASVM", "From:"))
        self.label_44.setText(_translate("frmMASVM", "To:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmMASVM", "Fold"))
        self.groupBox_3.setTitle(_translate("frmMASVM", "<Based on a reference>"))
        self.cbFilterTrID.setText(_translate("frmMASVM", "Filter training based on"))
        self.label_6.setText(_translate("frmMASVM", "Remove training contents"))
        self.label_21.setText(_translate("frmMASVM", "e.g. 0 or [1,2]"))
        self.label_22.setText(_translate("frmMASVM", "e.g. 0 or [1,2]"))
        self.cbFilterTeID.setText(_translate("frmMASVM", "Filter testing based on"))
        self.label_23.setText(_translate("frmMASVM", "Remove testing contents"))
        self.btnShowFilterContent.setText(_translate("frmMASVM", "Show Content"))
        self.groupBox_2.setTitle(_translate("frmMASVM", "<Filter based on Class ID>"))
        self.label_10.setText(_translate("frmMASVM", "Existed Classes"))
        self.label_4.setText(_translate("frmMASVM", "Remove Class IDs"))
        self.txtFilter.setText(_translate("frmMASVM", "0"))
        self.label_5.setText(_translate("frmMASVM", "e.g. 0 or [1,2]"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("frmMASVM", "Filter"))
        self.cbAverage.setText(_translate("frmMASVM", "Average"))
        self.cbPrecision.setText(_translate("frmMASVM", "Precision"))
        self.cbAPrecision.setText(_translate("frmMASVM", "Average of Precision"))
        self.cbRecall.setText(_translate("frmMASVM", "Recall"))
        self.cbF1.setText(_translate("frmMASVM", "f1 score"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("frmMASVM", "Metrics"))
        self.label_12.setText(_translate("frmMASVM", "$FOLD$ will be replaced by fold number."))
        self.btnOutModel.setText(_translate("frmMASVM", "..."))
        self.label_36.setText(_translate("frmMASVM", "Models (per fold/opt)"))
