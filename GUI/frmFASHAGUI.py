...
# Form implementation generated from reading ui file 'frmFASHAGUI.ui'
#
...
class Ui_frmFASHA(object):
    def setupUi(self, frmFASHA):
        ...
        self.txtLambda = QtWidgets.QLineEdit(self.tab_2)
        self.txtLambda.setGeometry(QtCore.QRect(260, 370, 160, 21))
        ...
        self.label_12 = QtWidgets.QLabel(frmFASHA)
        self.label_12.setGeometry(QtCore.QRect(185, 735, 421, 20))
        self.label_12.setObjectName("label_12")

        self.retranslateUi(frmFASHA)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(frmFASHA)
        frmFASHA.setTabOrder(self.txtInFile, self.btnInFile)
        frmFASHA.setTabOrder(self.btnInFile, self.txtOutFile)
        frmFASHA.setTabOrder(self.txtOutFile, self.btnOutFile)
        frmFASHA.setTabOrder(self.btnOutFile, self.tabWidget)
        frmFASHA.setTabOrder(self.tabWidget, self.cbmLabel)
        frmFASHA.setTabOrder(self.cbmLabel, self.cbCol)
        frmFASHA.setTabOrder(self.cbCol, self.cbDM)
        frmFASHA.setTabOrder(self.cbDM, self.cbTask)
        frmFASHA.setTabOrder(self.cbTask, self.cbRun)
        frmFASHA.setTabOrder(self.cbRun, self.cbCounter)
        frmFASHA.setTabOrder(self.cbCounter, self.cbCond)
        frmFASHA.setTabOrder(self.cbCond, self.cbNScan)
        frmFASHA.setTabOrder(self.cbNScan, self.txtITrData)
        frmFASHA.setTabOrder(self.txtITrData, self.txtITrLabel)
        frmFASHA.setTabOrder(self.txtITrLabel, self.txtITrSubject)
        frmFASHA.setTabOrder(self.txtITrSubject, self.txtITrmLabel)
        frmFASHA.setTabOrder(self.txtITrmLabel, self.txtCol)
        frmFASHA.setTabOrder(self.txtCol, self.txtITrDM)
        frmFASHA.setTabOrder(self.txtITrDM, self.txtITrTask)
        frmFASHA.setTabOrder(self.txtITrTask, self.txtITrRun)
        frmFASHA.setTabOrder(self.txtITrRun, self.txtITrCounter)
        frmFASHA.setTabOrder(self.txtITrCounter, self.txtITrScan)
        frmFASHA.setTabOrder(self.txtITrScan, self.txtOTrData)
        frmFASHA.setTabOrder(self.txtOTrData, self.txtOTrLabel)
        frmFASHA.setTabOrder(self.txtOTrLabel, self.txtOTrSubject)
        frmFASHA.setTabOrder(self.txtOTrSubject, self.txtOTrmLabel)
        frmFASHA.setTabOrder(self.txtOTrmLabel, self.txtOCol)
        frmFASHA.setTabOrder(self.txtOCol, self.txtOTrDM)
        frmFASHA.setTabOrder(self.txtOTrDM, self.txtOTrTask)
        frmFASHA.setTabOrder(self.txtOTrTask, self.txtOTrRun)
        frmFASHA.setTabOrder(self.txtOTrRun, self.txtOTrCounter)
        frmFASHA.setTabOrder(self.txtOTrCounter, self.txtOCond)
        frmFASHA.setTabOrder(self.txtOCond, self.txtOTrScan)
        frmFASHA.setTabOrder(self.txtOTrScan, self.txtCond)
        frmFASHA.setTabOrder(self.txtCond, self.btnConvert)
        frmFASHA.setTabOrder(self.btnConvert, self.btnClose)

    def retranslateUi(self, frmFASHA):
        _translate = QtCore.QCoreApplication.translate
        frmFASHA.setWindowTitle(_translate("frmFASHA", "Supervised Hyperalignment"))
        self.btnInFile.setText(_translate("frmFASHA", "..."))
        self.label_33.setText(_translate("frmFASHA", "Input Data"))
        self.btnOutFile.setText(_translate("frmFASHA", "..."))
        self.btnConvert.setText(_translate("frmFASHA", "Alignment"))
        self.label_35.setText(_translate("frmFASHA", "Output Data"))
        self.btnClose.setText(_translate("frmFASHA", "Close"))
        self.txtOTrTask.setText(_translate("frmFASHA", "train_task"))
        self.cbmLabel.setText(_translate("frmFASHA", "Label (matrix)"))
        self.txtOTrmLabel.setText(_translate("frmFASHA", "train_mlabel"))
        self.label_2.setText(_translate("frmFASHA", "Data"))
        self.txtOTrDM.setText(_translate("frmFASHA", "train_design"))
        self.cbTask.setText(_translate("frmFASHA", "Task"))
        self.label_3.setText(_translate("frmFASHA", "Label"))
        self.cbNScan.setText(_translate("frmFASHA", "NScan"))
        self.cbCond.setText(_translate("frmFASHA", "Condition"))
        self.cbDM.setText(_translate("frmFASHA", "Design Matrix"))
        self.cbCol.setText(_translate("frmFASHA", "Coordinate"))
        self.txtOCond.setText(_translate("frmFASHA", "condition"))
        self.label.setText(_translate("frmFASHA", "Input"))
        self.txtOTrLabel.setText(_translate("frmFASHA", "train_label"))
        self.txtOTrScan.setText(_translate("frmFASHA", "train_nscan"))
        self.cbCounter.setText(_translate("frmFASHA", "Counter"))
        self.txtOCol.setText(_translate("frmFASHA", "coordinate"))
        self.label_5.setText(_translate("frmFASHA", "Output"))
        self.txtOTrCounter.setText(_translate("frmFASHA", "train_counter"))
        self.txtOTrSubject.setText(_translate("frmFASHA", "train_subject"))
        self.cbRun.setText(_translate("frmFASHA", "Run"))
        self.txtOTrData.setText(_translate("frmFASHA", "train_data"))
        self.txtOTrRun.setText(_translate("frmFASHA", "train_run"))
        self.txtOTeLabel.setText(_translate("frmFASHA", "test_label"))
        self.txtOTeRun.setText(_translate("frmFASHA", "test_run"))
        self.txtOTemLabel.setText(_translate("frmFASHA", "test_mlabel"))
        self.txtOTeDM.setText(_translate("frmFASHA", "test_design"))
        self.txtOTeData.setText(_translate("frmFASHA", "test_data"))
        self.txtOTeCounter.setText(_translate("frmFASHA", "test_counter"))
        self.txtOTeSubject.setText(_translate("frmFASHA", "test_subject"))
        self.txtOTeTask.setText(_translate("frmFASHA", "test_task"))
        self.txtOTeScan.setText(_translate("frmFASHA", "test_nscan"))
        self.label_7.setText(_translate("frmFASHA", "Train"))
        self.label_8.setText(_translate("frmFASHA", "Test"))
        self.label_9.setText(_translate("frmFASHA", "Train"))
        self.label_10.setText(_translate("frmFASHA", "Test"))
        self.cbFoldID.setText(_translate("frmFASHA", "FoldID"))
        self.txtOFoldID.setText(_translate("frmFASHA", "FoldID"))
        self.cbFoldInfo.setText(_translate("frmFASHA", "FoldInfo"))
        self.txtOFoldInfo.setText(_translate("frmFASHA", "FoldInfo"))
        self.lbFoldID.setText(_translate("frmFASHA", "ID=None"))
        self.label_6.setText(_translate("frmFASHA", "Subject"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("frmFASHA", "Data"))
        self.groupBox.setTitle(_translate("frmFASHA", "<Input Data Normalization>"))
        self.cbScale.setText(_translate("frmFASHA", "Scale Data X~N(0,1)"))
        self.rbScale.setText(_translate("frmFASHA", "Subject Level"))
        self.radioButton.setText(_translate("frmFASHA", "Whole Data"))
        self.groupBox_2.setTitle(_translate("frmFASHA", "<Alignment Level>"))
        self.cbFTask.setText(_translate("frmFASHA", "Task"))
        self.cbFCounter.setText(_translate("frmFASHA", "Counter"))
        self.groupBox_3.setTitle(_translate("frmFASHA", "<Subject Level>"))
        self.cbFSubject.setText(_translate("frmFASHA", "Subject"))
        self.radioButton_2.setText(_translate("frmFASHA", "Without Run"))
        self.rbFRun.setText(_translate("frmFASHA", "With Run"))
        self.label_11.setText(_translate("frmFASHA", "Regularization"))
        self.txtRegularization.setText(_translate("frmFASHA", "0.0001"))
        self.lblFeaNum.setText(_translate("frmFASHA", "No Data"))
        self.label_4.setText(_translate("frmFASHA", "Number of features"))
        self.txtLambda.setText(_translate("frmFASHA", "-1"))
        self.label_13.setText(_translate("frmFASHA", "Lambda (-1 means 1/2Ti)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("frmFASHA", "Parameters"))
        self.label_17.setText(_translate("frmFASHA", "From:"))
        self.label_44.setText(_translate("frmFASHA", "To:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmFASHA", "Fold"))
        self.label_12.setText(_translate("frmFASHA", "$FOLD$ will be replaced by fold number."))
