...
class Ui_frmAAVoxel(object):
    def setupUi(self, frmAAVoxel):
        ...
        self.txtTeLabel.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)
        ...
        self.txtTeData.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)
        ...
        self.Code.setGeometry(QtCore.QRect(10, 10, 681, 201))
