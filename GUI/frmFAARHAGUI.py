...
# Form implementation generated from reading ui file 'frmFAARHAGUI.ui'
#
...
class Ui_frmFAARHA(object):
    def setupUi(self, frmFAARHA):
        ...
        self.txtRank.setGeometry(QtCore.QRect(260, 370, 160, 21))
        self.txtRank.setObjectName("txtRank")
        self.label_13 = QtWidgets.QLabel(self.tab_2)
        self.label_13.setGeometry(QtCore.QRect(30, 370, 221, 16))
        self.label_13.setObjectName("label_13")
        self.txtRho = QtWidgets.QLineEdit(self.tab_2)
        self.txtRho.setGeometry(QtCore.QRect(260, 410, 160, 21))
        ...
        self.label_12 = QtWidgets.QLabel(frmFAARHA)
        self.label_12.setGeometry(QtCore.QRect(185, 735, 421, 20))
        self.label_12.setObjectName("label_12")

        self.retranslateUi(frmFAARHA)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(frmFAARHA)
        frmFAARHA.setTabOrder(self.txtInFile, self.btnInFile)
        frmFAARHA.setTabOrder(self.btnInFile, self.txtOutFile)
        frmFAARHA.setTabOrder(self.txtOutFile, self.btnOutFile)
        frmFAARHA.setTabOrder(self.btnOutFile, self.tabWidget)
        frmFAARHA.setTabOrder(self.tabWidget, self.cbmLabel)
        frmFAARHA.setTabOrder(self.cbmLabel, self.cbCol)
        frmFAARHA.setTabOrder(self.cbCol, self.cbDM)
        frmFAARHA.setTabOrder(self.cbDM, self.cbTask)
        frmFAARHA.setTabOrder(self.cbTask, self.cbRun)
        frmFAARHA.setTabOrder(self.cbRun, self.cbCounter)
        frmFAARHA.setTabOrder(self.cbCounter, self.cbCond)
        frmFAARHA.setTabOrder(self.cbCond, self.cbNScan)
        frmFAARHA.setTabOrder(self.cbNScan, self.txtITrData)
        frmFAARHA.setTabOrder(self.txtITrData, self.txtITrLabel)
        frmFAARHA.setTabOrder(self.txtITrLabel, self.txtITrSubject)
        frmFAARHA.setTabOrder(self.txtITrSubject, self.txtITrmLabel)
        frmFAARHA.setTabOrder(self.txtITrmLabel, self.txtCol)
        frmFAARHA.setTabOrder(self.txtCol, self.txtITrDM)
        frmFAARHA.setTabOrder(self.txtITrDM, self.txtITrTask)
        frmFAARHA.setTabOrder(self.txtITrTask, self.txtITrRun)
        frmFAARHA.setTabOrder(self.txtITrRun, self.txtITrCounter)
        frmFAARHA.setTabOrder(self.txtITrCounter, self.txtITrScan)
        frmFAARHA.setTabOrder(self.txtITrScan, self.txtOTrData)
        frmFAARHA.setTabOrder(self.txtOTrData, self.txtOTrLabel)
        frmFAARHA.setTabOrder(self.txtOTrLabel, self.txtOTrSubject)
        frmFAARHA.setTabOrder(self.txtOTrSubject, self.txtOTrmLabel)
        frmFAARHA.setTabOrder(self.txtOTrmLabel, self.txtOCol)
        frmFAARHA.setTabOrder(self.txtOCol, self.txtOTrDM)
        frmFAARHA.setTabOrder(self.txtOTrDM, self.txtOTrTask)
        frmFAARHA.setTabOrder(self.txtOTrTask, self.txtOTrRun)
        frmFAARHA.setTabOrder(self.txtOTrRun, self.txtOTrCounter)
        frmFAARHA.setTabOrder(self.txtOTrCounter, self.txtOCond)
        frmFAARHA.setTabOrder(self.txtOCond, self.txtOTrScan)
        frmFAARHA.setTabOrder(self.txtOTrScan, self.txtCond)
        frmFAARHA.setTabOrder(self.txtCond, self.btnConvert)
        frmFAARHA.setTabOrder(self.btnConvert, self.btnClose)

    def retranslateUi(self, frmFAARHA):
        _translate = QtCore.QCoreApplication.translate
        frmFAARHA.setWindowTitle(_translate("frmFAARHA", "Regularization Hyperalignment"))
        self.btnInFile.setText(_translate("frmFAARHA", "..."))
        self.label_33.setText(_translate("frmFAARHA", "Input Data"))
        self.btnOutFile.setText(_translate("frmFAARHA", "..."))
        self.btnConvert.setText(_translate("frmFAARHA", "Alignment"))
        self.label_35.setText(_translate("frmFAARHA", "Output Data"))
        self.btnClose.setText(_translate("frmFAARHA", "Close"))
        self.txtOTrTask.setText(_translate("frmFAARHA", "train_task"))
        self.cbmLabel.setText(_translate("frmFAARHA", "Label (matrix)"))
        self.txtOTrmLabel.setText(_translate("frmFAARHA", "train_mlabel"))
        self.label_2.setText(_translate("frmFAARHA", "Data"))
        self.txtOTrDM.setText(_translate("frmFAARHA", "train_design"))
        self.cbTask.setText(_translate("frmFAARHA", "Task"))
        self.label_3.setText(_translate("frmFAARHA", "Label"))
        self.cbNScan.setText(_translate("frmFAARHA", "NScan"))
        self.cbCond.setText(_translate("frmFAARHA", "Condition"))
        self.cbDM.setText(_translate("frmFAARHA", "Design Matrix"))
        self.cbCol.setText(_translate("frmFAARHA", "Coordinate"))
        self.txtOCond.setText(_translate("frmFAARHA", "condition"))
        self.label.setText(_translate("frmFAARHA", "Input"))
        self.txtOTrLabel.setText(_translate("frmFAARHA", "train_label"))
        self.txtOTrScan.setText(_translate("frmFAARHA", "train_nscan"))
        self.cbCounter.setText(_translate("frmFAARHA", "Counter"))
        self.txtOCol.setText(_translate("frmFAARHA", "coordinate"))
        self.label_5.setText(_translate("frmFAARHA", "Output"))
        self.txtOTrCounter.setText(_translate("frmFAARHA", "train_counter"))
        self.txtOTrSubject.setText(_translate("frmFAARHA", "train_subject"))
        self.cbRun.setText(_translate("frmFAARHA", "Run"))
        self.txtOTrData.setText(_translate("frmFAARHA", "train_data"))
        self.txtOTrRun.setText(_translate("frmFAARHA", "train_run"))
        self.txtOTeLabel.setText(_translate("frmFAARHA", "test_label"))
        self.txtOTeRun.setText(_translate("frmFAARHA", "test_run"))
        self.txtOTemLabel.setText(_translate("frmFAARHA", "test_mlabel"))
        self.txtOTeDM.setText(_translate("frmFAARHA", "test_design"))
        self.txtOTeData.setText(_translate("frmFAARHA", "test_data"))
        self.txtOTeCounter.setText(_translate("frmFAARHA", "test_counter"))
        self.txtOTeSubject.setText(_translate("frmFAARHA", "test_subject"))
        self.txtOTeTask.setText(_translate("frmFAARHA", "test_task"))
        self.txtOTeScan.setText(_translate("frmFAARHA", "test_nscan"))
        self.label_7.setText(_translate("frmFAARHA", "Train"))
        self.label_8.setText(_translate("frmFAARHA", "Test"))
        self.label_9.setText(_translate("frmFAARHA", "Train"))
        self.label_10.setText(_translate("frmFAARHA", "Test"))
        self.cbFoldID.setText(_translate("frmFAARHA", "FoldID"))
        self.txtOFoldID.setText(_translate("frmFAARHA", "FoldID"))
        self.cbFoldInfo.setText(_translate("frmFAARHA", "FoldInfo"))
        self.txtOFoldInfo.setText(_translate("frmFAARHA", "FoldInfo"))
        self.lbFoldID.setText(_translate("frmFAARHA", "ID=None"))
        self.label_6.setText(_translate("frmFAARHA", "Subject"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("frmFAARHA", "Data"))
        self.groupBox.setTitle(_translate("frmFAARHA", "<Input Data Normalization>"))
        self.cbScale.setText(_translate("frmFAARHA", "Scale Data X~N(0,1)"))
        self.rbScale.setText(_translate("frmFAARHA", "Subject Level"))
        self.radioButton.setText(_translate("frmFAARHA", "Whole Data"))
        self.groupBox_2.setTitle(_translate("frmFAARHA", "<Alignment Level>"))
        self.cbFTask.setText(_translate("frmFAARHA", "Task"))
        self.cbFCounter.setText(_translate("frmFAARHA", "Counter"))
        self.groupBox_3.setTitle(_translate("frmFAARHA", "<Subject Level>"))
        self.cbFSubject.setText(_translate("frmFAARHA", "Subject"))
        self.radioButton_2.setText(_translate("frmFAARHA", "Without Run"))
        self.rbFRun.setText(_translate("frmFAARHA", "With Run"))
        self.label_11.setText(_translate("frmFAARHA", "Regularization"))
        self.txtRegularization.setText(_translate("frmFAARHA", "0.0001"))
        self.lblFeaNum.setText(_translate("frmFAARHA", "No Data"))
        self.label_4.setText(_translate("frmFAARHA", "Number of features"))
        self.txtRank.setText(_translate("frmFAARHA", "1"))
        self.label_13.setText(_translate("frmFAARHA", "Autoregressive rank"))
        self.txtRho.setText(_translate("frmFAARHA", "0.5"))
        self.label_14.setText(_translate("frmFAARHA", "Autoregressive rho"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("frmFAARHA", "Parameters"))
        self.label_17.setText(_translate("frmFAARHA", "From:"))
        self.label_44.setText(_translate("frmFAARHA", "To:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("frmFAARHA", "Fold"))
        self.label_12.setText(_translate("frmFAARHA", "$FOLD$ will be replaced by fold number."))
