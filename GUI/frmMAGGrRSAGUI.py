...
class Ui_frmMAGGrRSA(object):
    ...
    def retranslateUi(self, frmMAGGrRSA):
        ...
        self.label_31.setText(_translate("frmMAGGrRSA", "Condition"))
        ...
        self.txtEL1.setText(_translate("frmMAGGrRSA", "0.5"))
        self.cbVerbose.setText(_translate("frmMAGGrRSA", "Verbose"))
        self.label_13.setText(_translate("frmMAGGrRSA", "Method"))
        self.label_16.setText(_translate("frmMAGGrRSA", "Epoch"))
        self.txtBatch.setText(_translate("frmMAGGrRSA", "10"))
        self.label_22.setText(_translate("frmMAGGrRSA", "Elastic Lambda 1"))
        self.txtLParam.setText(_translate("frmMAGGrRSA", "1"))
        self.label_18.setText(_translate("frmMAGGrRSA", "Report Step every"))
        self.label_17.setText(_translate("frmMAGGrRSA", "Batch Size"))
        self.txtEL2.setText(_translate("frmMAGGrRSA", "1"))
        self.txtRRP.setText(_translate("frmMAGGrRSA", "1"))
        self.txtIter.setText(_translate("frmMAGGrRSA", "10"))
        self.label_19.setText(_translate("frmMAGGrRSA", "Learning Rate"))
        self.label_23.setText(_translate("frmMAGGrRSA", "Elastic Alpha"))
        self.label_15.setText(_translate("frmMAGGrRSA", "Optimization"))
        self.txtReportStep.setText(_translate("frmMAGGrRSA", "2"))
        self.label_14.setText(_translate("frmMAGGrRSA", "Loss Type"))
        self.txtRate.setText(_translate("frmMAGGrRSA", "0.1"))
        self.label_20.setText(_translate("frmMAGGrRSA", "LASSO Alpha"))
        ...
        self.label_29.setText(_translate("frmMAGGrRSA", "Figure Title: Corr (Null = Auto)"))
        self.label_28.setText(_translate("frmMAGGrRSA", "Figure Title: Cov (Null = Auto)"))
        self.label_27.setText(_translate("frmMAGGrRSA", "Font Size"))
        self.label_30.setText(_translate("frmMAGGrRSA", "Figure Title: Den (Null = Auto)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("frmMAGGrRSA", "Options"))
