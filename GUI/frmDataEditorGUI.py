...
class Ui_frmDataEditor(object):
    def setupUi(self, frmDataEditor):
        ...
        self.btnClose = QtWidgets.QPushButton(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("../Icons/icons8-3d-model-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnSelectSection.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("../Icons/icons8-3d-object-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, frmDataEditor):
        ...
        self.btnClose.setToolTip(_translate("frmDataEditor", "Exit"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("frmDataEditor", "File"))
        ...
        self.menuExit.setTitle(_translate("frmDataEditor", "Exit"))
