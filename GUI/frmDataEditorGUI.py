...
class Ui_frmDataEditor(object):
    def setupUi(self, frmDataEditor):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../Icons/icons8-rename-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnRename.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../Icons/icons8-delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnRemove.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../Icons/icons8-rotate-left-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnTranspose.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../Icons/icons8-normal-distribution-histogram-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnScale.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../Icons/icons8-clone-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnClone.setIcon(icon11)
        ...
        self.btnSelectSection = QtWidgets.QPushButton(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnSelectSection.sizePolicy().hasHeightForWidth())
        self.btnSelectSection.setSizePolicy(sizePolicy)
        self.btnSelectSection.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("../Icons/icons8-3d-model-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnSelectSection.setIcon(icon12)
        self.btnSelectSection.setIconSize(QtCore.QSize(48, 48))
        self.btnSelectSection.setObjectName("btnSelectSection")
        self.horizontalLayout_4.addWidget(self.btnSelectSection)
        ...
        self.menuFile.setGeometry(QtCore.QRect(309, 169, 184, 100))
        self.menuFile.setTitle("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("../Icons/icons8-menu.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuFile.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("../Icons/icons8-shutdown-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, frmDataEditor):
        ...
        self.btnSelectSection.setToolTip(_translate("frmDataEditor", "Select Part of Data"))
