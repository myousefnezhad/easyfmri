...
class Ui_frmMAGPUSVM(object):
    def setupUi(self, frmMAGPUSVM):
        ...
        self.cbPenalty = QtWidgets.QCheckBox(self.tab_2)
        self.cbPenalty.setGeometry(QtCore.QRect(180, 480, 231, 20))
        self.cbPenalty.setChecked(True)
    ...
    def retranslateUi(self, frmMAGPUSVM):
        ...
        self.cbPenalty.setText(_translate("frmMAGPUSVM", "Apply norm 2 penalty"))
