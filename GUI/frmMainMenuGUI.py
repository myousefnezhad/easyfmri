...
class Ui_frmMainMenuGUI(object):
    def setupUi(self, frmMainMenuGUI):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-brain-128.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/Icons/402612-200.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnPreprocess.setIcon(icon1)
        self.btnPreprocess.setIconSize(QtCore.QSize(100, 100))
        self.btnPreprocess.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-scatter-plot-filled-64.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnFeatureAnalysis.setIcon(icon2)
        self.btnFeatureAnalysis.setIconSize(QtCore.QSize(100, 100))
        self.btnFeatureAnalysis.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/Icons/noun_mind_1705433.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnModelAnalysis.setIcon(icon3)
        self.btnModelAnalysis.setIconSize(QtCore.QSize(100, 100))
        self.btnModelAnalysis.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/Icons/noun_Brain_7784.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnVisualization.setIcon(icon4)
        self.btnVisualization.setIconSize(QtCore.QSize(100, 100))
        self.btnVisualization.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-play-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnTools.setIcon(icon5)
        self.btnTools.setIconSize(QtCore.QSize(100, 100))
        self.btnTools.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-administrative-tools-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnStable.setIcon(icon6)
        self.btnStable.setIconSize(QtCore.QSize(100, 100))
        self.btnStable.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-settings-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnDev.setIcon(icon7)
        self.btnDev.setIconSize(QtCore.QSize(100, 100))
        self.btnDev.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-installing-updates-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnUpdate.setIcon(icon8)
        self.btnUpdate.setIconSize(QtCore.QSize(100, 100))
        self.btnUpdate.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.DelayedPopup)
        self.btnUpdate.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-shutdown-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnExit.setIcon(icon9)
        self.btnExit.setIconSize(QtCore.QSize(100, 100))
        self.btnExit.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.DelayedPopup)
        self.btnExit.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.btnExit.setObjectName("btnExit")
        self.btnAbout = QtWidgets.QToolButton(frmMainMenuGUI)
        self.btnAbout.setGeometry(QtCore.QRect(10, 330, 160, 150))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/Icons/icons8-whatsapp-100.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
