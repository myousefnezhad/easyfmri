...
class Ui_frmModelAnalysis(object):
    def setupUi(self, frmModelAnalysis):
        ...
        self.btnSKModel.setGeometry(QtCore.QRect(20, 130, 641, 32))
        self.btnSKModel.setObjectName("btnSKModel")
        self.btnSKCModel = QtWidgets.QPushButton(self.tab_2)
        self.btnSKCModel.setGeometry(QtCore.QRect(20, 180, 641, 32))
        self.btnSKCModel.setObjectName("btnSKCModel")
        self.btnReport = QtWidgets.QPushButton(self.tab_2)
        self.btnReport.setGeometry(QtCore.QRect(20, 80, 641, 32))
    ...
    def retranslateUi(self, frmModelAnalysis):
        ...
        self.btnReport.setText(_translate("frmModelAnalysis", "Report from multi-file results"))
