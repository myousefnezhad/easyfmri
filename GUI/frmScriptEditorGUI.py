...
class Ui_frmScriptEditor(object):
    def setupUi(self, frmScriptEditor):
        ...
        self.txtTask.setGeometry(QtCore.QRect(120, 70, 481, 21))
    ...
    def retranslateUi(self, frmScriptEditor):
        ...
        self.txtRunRange.setText(_translate("frmScriptEditor", "{1x[1*1-1]}"))
        ...
        self.label_5.setText(_translate("frmScriptEditor", "Task Name(s):"))
        self.txtTask.setToolTip(_translate("frmScriptEditor", "<html><head/><body><p><span style=\" font-size:18pt; color:#0000ff;\">Task Names: a unique array of integers, i.e., [task1, task2, ...]</span></p><p><span style=\" font-size:18pt; color:#0000ff;\">, is the separator</span></p></body></html>"))
