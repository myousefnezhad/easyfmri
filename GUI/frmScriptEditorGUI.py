...
class Ui_frmScriptEditor(object):
    def setupUi(self, frmScriptEditor):
        ...
        self.label_23.setGeometry(QtCore.QRect(20, 610, 591, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, frmScriptEditor):
        ...
        self.label_23.setText(_translate("frmScriptEditor", "$MAINDIR$, $SUB$, $TASK$, $RUN$, $COUNT$ will be replaced by the preprocessing parameters.\n"
"It\'s case sensitive."))
