...
class Ui_frmVisalization(object):
    def setupUi(self, frmVisalization):
        ...
        self.btnTools.setGeometry(QtCore.QRect(16, 90, 791, 51))
        self.btnTools.setObjectName("btnTools")
        self.cbTools = QtWidgets.QComboBox(self.tab_2)
        self.cbTools.setGeometry(QtCore.QRect(16, 40, 791, 26))
        self.cbTools.setObjectName("cbTools")
        self.label_10 = QtWidgets.QLabel(self.tab_2)
        self.label_10.setGeometry(QtCore.QRect(20, 20, 471, 20))
    ...
    def retranslateUi(self, frmVisalization):
        ...
        self.btnTools.setText(_translate("frmVisalization", "Run"))
        self.label_10.setText(_translate("frmVisalization", "Select a tool:"))
