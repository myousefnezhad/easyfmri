...
class Ui_frmMAClassicNetwork(object):
    ...
    def retranslateUi(self, frmMAClassicNetwork):
        ...
        self.label_27.setText(_translate("frmMAClassicNetwork", "Font Size"))
        self.label_28.setText(_translate("frmMAClassicNetwork", "Figure Title: Cov (Null = Auto)"))
        self.label_29.setText(_translate("frmMAClassicNetwork", "Figure Title: Corr (Null = Auto)"))
        self.label_30.setText(_translate("frmMAClassicNetwork", "Figure Title: Den (Null = Auto)"))
        self.label_34.setText(_translate("frmMAClassicNetwork", "X Rotation"))
        self.label_36.setText(_translate("frmMAClassicNetwork", "Y Rotation"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("frmMAClassicNetwork", "Options"))
